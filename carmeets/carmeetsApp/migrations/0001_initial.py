# Generated by Django 6.0.5 on 2026-05-09 19:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.CharField(choices=[('admin', 'Admin'), ('user', 'User'), ('guest', 'Guest')], default='guest', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='carmeetsApp.event')),
            ],
        ),
        migrations.CreateModel(
            name='Report',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='carmeetsApp.comment')),
